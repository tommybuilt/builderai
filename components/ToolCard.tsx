...
export function ToolCard({ tool, showRatingPrompt = false }: ToolCardProps) {
  ...
  return (
    <div className="group relative bg-white dark:bg-zinc-900/50 border border-zinc-300 dark:border-zinc-800 rounded-xl p-5 
      ...
      <div className="absolute top-3 right-3">
        <ToolActions toolId={tool.id} size="sm" onHiddenChange={setIsHidden} />
      </div>
